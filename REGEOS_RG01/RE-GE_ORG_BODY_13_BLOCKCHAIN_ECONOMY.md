...
This version:
	•	[OK] Fixes all heading structure issues
	•	[OK] Uses only valid --- horizontal rules
	•	[OK] Uses proper backticks for code blocks
	•	[OK] Includes the AMENDMENTS_LOG at the bottom in Outline-compatible format
