...
def main():
    ...
    print(f"   [OK] Base habitat established: {base_habitat.name}")
    ...
    print(f"   [OK] Experiment spawned: {myth_engine.name}")
    print(f"   [LOCKED] Containment boundary: {myth_engine.boundary.get_full_path()}")
    print()
    ...
    print(f"   [OK] Nested experiment spawned: {analyzer.name}")
    print(f"   [LOCKED] Nested boundary: {analyzer.boundary.get_full_path()}")
    print()
    ...
    print(f"   [OK] Deep habitat created: {deep_habitat.name}")
    print(f"   [INFO] Nesting depth: {deep_habitat.nesting_depth}")
    print(f"   [LOCKED] Isolation level: {deep_habitat.isolation_level}")
    ...
    print(f"   [OK] Deep experiment spawned: {synthesizer.name}")
    print(f"   [LOCKED] Deep boundary: {synthesizer.boundary.get_full_path()}")
    print()
    
    # Execute experiments from deepest to shallowest
    print("[LAUNCH] RUNNING EXPERIMENTS (deepest to shallowest)...")
    print("-" * 60)
    
    # Run deepest experiment first
    print("[RUN] Running Layer 3: Synthesis Engine...")
    synthesis_result = deep_habitat.run_experiment(synthesizer.name)
    print("   [INFO] Synthesis Results:")
    for key, value in synthesis_result.items():
        print(f"      {key}: {value}")
    print()
    
    # Run nested experiment
    print("[RUN] Running Layer 2: Pattern Analyzer...")
    ...
    print("[INFO] Nested Habitat (Layer 2):")
    ...
    print("[INFO] Deep Habitat (Layer 3):")
    ...
    print("[GRAD] GRADUATION PROCESS (deepest to shallowest)...")
    print("-" * 60)
    
    # Graduate synthesis to nested habitat
    print("[GRAD] Graduating synthesis engine to pattern analyzer level...")
    synthesis_package = deep_habitat.graduate_to_forge(synthesizer.name)
    print(f"   [OK] Synthesis patterns ready for integration")
    
    # Graduate analyzer to base habitat  
    print("[GRAD] Graduating pattern analyzer to base level...")
    analysis_package = nested_habitat.graduate_to_forge(analyzer.name)
    print(f"   [OK] Analysis patterns ready for integration")
    
    # Graduate myth engine to Code Forge
    print("[GRAD] Graduating myth engine to Code Forge...")
    myth_package = base_habitat.graduate_to_forge(myth_engine.name)
    print(f"   [OK] Myth engine patterns ready for production")
    print()
    
    # Show final summary
    print("[DONE] HAT STACK EXPERIMENT COMPLETE!")
    print("=" * 60)
    print("Successfully demonstrated:")
    print("[OK] Multi-layer experimental containment")
    print("[OK] Nested habitat creation and management") 
    print("[OK] Safe experiment execution at each layer")
    print("[OK] Graduation of successful patterns upward")
    print("[OK] Complete isolation and boundary management")
    print()
    print("The 'hat on a hat on a' containment system provides:")
    print("[TARGET] Progressive isolation levels for risk management")
    print("[TARGET] Recursive experimentation without contamination")
    print("[TARGET] Safe graduation paths for successful patterns")
    print("[TARGET] Complete failure containment and composting")
    print()
    
    # Cleanup
    print("[CLEANUP] Cleaning up experimental environments...")
    base_habitat.cleanup()
    nested_habitat.cleanup() 
    deep_habitat.cleanup()
    print("[OK] All habitats cleaned up successfully")
