# VAULT_NAMING_GUIDE.md

Should the symbolic vault folder itself have a UID-style name?
...
## NAMING STRUCTURE (WHEN YOU UID THE VAULT):

**Format:**
`CC-CC_00-00_NAME_v#`

**Example:**
`SS-ST_00-00_4_S0VRC3_v2a/`

- `SS-ST` → System Stack / Structure
- `00-00` → Genesis build version
- `4_S0VRC3` → Symbolic OS name
- `v2a` → Semantic or lettered build tag
